...
class CrossOveredBudget(models.Model):
    ...
    def show_costsheet(self):
        ...
        res = self.env['ir.actions.act_window']._for_xml_id('odoo_job_costing_management.action_job_costing')
        # res = res.sudo().read()[0]
    ...
    def show_costsheet_line(self):
        ...
        # res = res.sudo().read()[0]
        res = self.env['ir.actions.act_window']._for_xml_id('job_costing_budget_contracting.action_cost_sheet_line_budget')
